...
- External review context uses `collect-review-context --redacted-diff --max-bytes 40000 --per-file-bytes 8192` with generated/binary file exclusion and redaction. Do not duplicate that collection logic in skills or forwarding agents.
