...
<body>
  <main>
    <header>
      <div>
        <h1>PZA Settings</h1>
        <p>Configure reviewer backends, second-opinion policy, and adversarial lanes used by /arewedone.</p>
      </div>
      <div class="actions">
  ...
  <script>
    ...
    function collect() {
      ...
      const payload = { secondOpinionMode: secondOpinionModeEl.value, adversarial: adversarialEl.checked, reviewers, checks };
