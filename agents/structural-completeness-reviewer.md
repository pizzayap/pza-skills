...
description: |
  ...
  Examples:
  - <example>
    Context: User wants to verify their work is complete.
    user: "are we done?"
    assistant: "Let me run a structural completeness review on your changes."
    <commentary>
    Explicit completeness check request triggers the structural-completeness-reviewer agent.
    </commentary>
    </example>
  - <example>
